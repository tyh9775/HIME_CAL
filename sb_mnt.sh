...
result_dir="sb_mnt_results" #output directory
...
if [ $initialize == true ]
then
    root -b -q -l "shadowAna_rbs_v3.C({$runs_23},\"${result_dir}/runs23\",\"${par_name}.txt\",\"${lin_par_name}.txt\",true,${use_veto},${a_mat},$evt_norm)"
    root -b -q -l "shadowAna_rbs_v3.C({$runs_34},\"${result_dir}/runs34\",\"${par_name}.txt\",\"${lin_par_name}.txt\",true,${use_veto},${a_mat},$evt_norm)"
    root -b -q -l "shadowAna_rbs_v3.C({$runs_34n},\"${result_dir}/runs34n\",\"${par_name}.txt\",\"${lin_par_name}.txt\",true,${use_veto},${a_mat},$evt_norm)"
    root -b -q -l "shadowAna_rbs_v3.C({$runs_4},\"${result_dir}/runs4\",\"${par_name}.txt\",\"${lin_par_name}.txt\",true,${use_veto},${a_mat},$evt_norm)"
    root -b -q -l "shadowAna_rbs_v3.C({$runs_all},\"${result_dir}/runs-all\",\"${par_name}.txt\",\"${lin_par_name}.txt\",true,${use_veto},${a_mat},$evt_norm)"
fi
...
then 
    ...
    root -b -q -l "sb_combiner_v3.cpp({\"${result_dir}/runs34-mnt.root\",\"${result_dir}/runs34n-mnt.root\",\"${result_dir}/runs4-mnt.root\"},\"${result_dir}/noSB2-mnt-new.root\",${use_veto},$num_list2,$scl_ftr)" 
    root -b -q -l "sb_combiner_v3.cpp({\"${result_dir}/runs23-mnt.root\",\"${result_dir}/runs34-mnt.root\",\"${result_dir}/runs34n-mnt.root\"},\"${result_dir}/SB3-mnt-new.root\",${use_veto},$num_list3,$scl_ftr)" 

    #combine all
    root -b -q -l "sb_combiner_v3.cpp({\"${result_dir}/runs23-mnt.root\",\"${result_dir}/runs34-mnt.root\",\"${result_dir}/runs34n-mnt.root\",\"${result_dir}/runs4-mnt.root\"},\"${result_dir}/all-cmb-mnt.root\",${use_veto},$num_list,$scl_ftr)"
fi

if [ $compare == true ]
then
    root -b -q -l "shadow_comp_v5.cpp({\"${result_dir}/runs23-mnt.root\",\"${result_dir}/SB3-mnt-new.root\",\"${result_dir}/noSB2-mnt-new.root\"},{\"${result_dir}/noSB2-mnt-new.root\",\"${result_dir}/runs4-mnt.root\",\"${result_dir}/runs23-mnt.root\"},\"${result_dir}/comp-new\")"
    root -b -q -l "visualize_comp_v4.cpp(\"${result_dir}/comp-new.root\",\"${result_dir}/comp-vis-new.root\")"
...
then
    ...
    root -b -q -l "grid_make_v3.cpp(\"${result_dir}/runs-all-hit.root\",\"${result_dir}/grid/ogb\",\"${result_dir}/comp-new_res/ogb.txt\",$num_list)"
    root -b -q -l "grid_make_v3.cpp(\"${result_dir}/runs-all-hit.root\",\"${result_dir}/grid/rb\",\"${result_dir}/comp-new_res/rb.txt\",$num_list)"
